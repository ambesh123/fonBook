...
public class DeleteFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("DELETE CONTACT");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
           ...
           Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/db","root","44221100");
            ...
            //Fire Queries to Delete Entries
            stmt.executeUpdate("delete from "+TABLE_NAME+" where name = '"+jTextField1.getText()+"'");
            javax.swing.JOptionPane.showMessageDialog(null,"Contact Deleted");
            jTextField1.setText("");
        }
        catch(Exception e){
